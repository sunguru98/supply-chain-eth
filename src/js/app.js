App = {
  ...
  getMetaskAccountID: async function () {
    ...
    try {
      ...
      $("#originFarmerID").val(accounts[1] || App.metamaskAccountID);
      $("#distributorID").val(accounts[2] || App.metamaskAccountID);
      $("#retailerID").val(accounts[3] || App.metamaskAccountID);
      $("#consumerID").val(accounts[4] || App.metamaskAccountID);
      App.ownerID = App.metamaskAccountID;
      App.originFarmerID = accounts[1] || App.metamaskAccountID;
      App.distributorID = accounts[2] || App.metamaskAccountID;
      App.retailerID = accounts[3] || App.metamaskAccountID;
      App.consumerID = accounts[4] || App.metamaskAccountID;
    } catch (err) {
